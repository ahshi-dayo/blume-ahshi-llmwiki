...
> ツール・手法・パターンなどの説明書を集めたディレクトリ。
> コンパイル済みwiki記事のうち、特定のトピックに属さない横断的な資料を置く。
...
|[LLM Wiki パターン リファレンス](/references/llm-wiki/)|KarpathyのLLM Wikiパターン。3層構造・Ingest/Query/Lint操作。2026年にLetta MemFS・Perplexity Brain・CodeAlmanac等が同じ原理へ収斂した経緯を追記。| llm-wiki, knowledge-base, andrej-karpathy, wiki-pattern, agentic-memory |2026-08-27|
